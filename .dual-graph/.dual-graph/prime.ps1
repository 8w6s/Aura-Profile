$port = if (Test-Path 'C:\Users\FUJITSU\Documents\PROJECTS\8w6s_profile\.dual-graph\.dual-graph\mcp_port') { Get-Content 'C:\Users\FUJITSU\Documents\PROJECTS\8w6s_profile\.dual-graph\.dual-graph\mcp_port' } else { '8080' }
try {
...
$ctxFile = 'C:\Users\FUJITSU\Documents\PROJECTS\8w6s_profile\.dual-graph\CONTEXT.md'
if (Test-Path $ctxFile) { Write-Output ""; Write-Output "=== CONTEXT.md ==="; Get-Content $ctxFile -Raw; Write-Output "=== end CONTEXT.md ===" }
$storeFile = 'C:\Users\FUJITSU\Documents\PROJECTS\8w6s_profile\.dual-graph\.dual-graph\context-store.json'
