...
export const ProfileProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [workflow, setWorkflow] = useState<ProfileWorkflowMeta>({ revisions: [], updatedAt: null, publishedAt: null });
  const [isLoading, setIsLoading] = useState(true);
  const [authError, setAuthError] = useState(false);

  const applyWorkflowResponse = (profileData: ProfileData, workflowData?: ProfileWorkflowMeta) => {
